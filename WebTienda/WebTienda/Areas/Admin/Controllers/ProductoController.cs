...
namespace InventoryWeb.Areas.Admin.Controllers
{
    ...
    public class ProductoController : Controller
    {
        ...
        {
            ProductoVM productoVM = new ProductoVM();
            productoVM.ProductoLista = _unidadTrabajo.Producto.ObtenerTodos(IncluirPropiedades: "Categoria,Marca");
        ...
        public IActionResult Delete(int id)
        {
            ...
            if (productoDb == null)
            {
                return Json(new { success = false, message = "Error al Borrar La Pelicula" });
            }
            ...
            _unidadTrabajo.Guardar();
            return Json(new { success = true, message = "Pelicula Borrada Exitosamente" });
        }
