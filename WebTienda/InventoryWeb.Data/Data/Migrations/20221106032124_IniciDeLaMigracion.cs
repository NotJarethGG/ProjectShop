...
{
    public partial class IniciDeLaMigracion : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Productos_Categorias_CategoriaRefid",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductoRefId = table.Column<int>(type: "int", nullable: true),
                    BodegaRefid = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BodegaProducto_Bodegas_BodegaRefid",
                        column: x => x.BodegaRefid,
                        principalTable: "Bodegas",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BodegaProducto_Productos_ProductoRefId",
                        column: x => x.ProductoRefId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BodegaProducto_BodegaRefid",
                table: "BodegaProducto",
                column: "BodegaRefid");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BodegaProducto_ProductoRefId",
                table: "BodegaProducto",
                column: "ProductoRefId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Productos_CategoriaRefid",
                table: "Productos",
